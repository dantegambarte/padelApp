...
@Injectable()
export class ReservationsPageFacade {
  ...
  readonly getStatusLabel = (status: ReservationStatus): string =>
    this.statusLabels[status];

  readonly getDepositBadge = (
  ...
  readonly statusClass = (reservation: Reservation): string => {
  ...
  setPayDeposit(value: boolean) {
    this.reservationForm.controls.payDeposit.setValue(value);
  }
